...
export const SidebarFooter = ({ user, isCollapsed, isMobile }: SidebarFooterProps) => {
  return (
    <div className={cn("mt-auto", isCollapsed ? "pt-2" : "pt-4")}>
      {user ? (
        <div className={cn("border-t border-gray-200 dark:border-gray-700", isCollapsed ? "pt-2" : "pt-4")}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Link to="/logout" className={cn(
                  ...
                  isCollapsed ? "gap-2 py-2 px-1 justify-center" : "gap-3 py-2.5 px-3"
                )}>
