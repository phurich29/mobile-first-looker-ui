    ...
    <Card className="dark:bg-slate-800 dark:border-slate-700">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          จัดการรหัสอุปกรณ์ที่ต้องการซ่อนจากการแสดงผลในระบบ (ค่าเริ่มต้น: แสดงทุกเครื่อง)
        </p>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground bg-muted/50 p-3 rounded-md">
          ...
          <ul className="space-y-1 list-disc list-inside">
            <li>ใส่รหัสอุปกรณ์ที่ต้องการซ่อนจากการแสดงผลในระบบ</li>
            <li>อุปกรณ์ที่ซ่อนจะไม่แสดงในหน้ารายการอุปกรณ์หลัก</li>
            <li>การตั้งค่านี้ใช้ได้เฉพาะบัญชี Admin เท่านั้น</li>
