...
export function UserSearchDebug() {
  ...
  const checkUserInDatabase = async () => {
    ...
    try {
      ...
      console.log("📋 Profiles query result:", { profileData, profileError });
      
      // 2. Check all profiles to see what's available
      ...
      const results = [
        { type: 'Profile Search', data: profileData, error: profileError },
        { type: 'All Profiles', data: allProfiles, error: allError },
  ...
  return (
    <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
      ...
      <Button 
        ...
        size="sm"
      >
        {isChecking ? "Checking..." : "Check demo5@demo.com in Database"}
      </Button>
