  ...
  return (
    <AppLayout wideContent showFooterNav contentPaddingBottom="pb-32 md:pb-16">
      ...
      <div className="mb-8 relative">
        ...
        {/* Device Access Management Link for SuperAdmin */}
        {isSuperAdmin && !isGuest && (
          <div className="mt-4">
            <Link to="/device-access-management">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors">
                <Settings className="h-4 w-4" />
                <span className="text-sm font-medium">จัดการสิทธิ์การเข้าถึงอุปกรณ์</span>
              </div>
            </Link>
          </div>
        )}
