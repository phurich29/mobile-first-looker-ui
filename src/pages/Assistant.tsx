      ...
      <div className="min-h-screen bg-gradient-to-br from-chinese-cream via-background to-chinese-cream/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-3">
            <Card className="border-4 border-medieval-dark bg-gradient-to-br from-medieval-parchment to-medieval-tan shadow-2xl h-full relative overflow-hidden before:absolute before:inset-0 before:border-4 before:border-medieval-dark/50 before:rounded-lg before:pointer-events-none">
