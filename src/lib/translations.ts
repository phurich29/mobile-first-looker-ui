export const translations = {
  ...
  measurements: {
    ...
    class2: { th: 'ชั้น 2 (>6.6-7.0mm)', en: 'Class 2' },
    class3: { th: 'ชั้น 3 (>6.2-6.6mm)', en: 'class3' },
    short_grain: { th: 'เมล็ดสั้น', en: 'short_grain' },
    slender_kernel: { th: 'ข้าวลีบ', en: 'slender_kernel' },
    whole_kernels: { th: 'เต็มเมล็ด', en: 'whole_kernels' },
    head_rice: { th: 'ต้นข้าว', en: 'head_rice' },
    total_brokens: { th: 'ข้าวหักรวม', en: 'total_brokens' },
    small_brokens: { th: 'ปลายข้าว', en: 'small_brokens' },
    small_brokens_c1: { th: 'ปลายข้าวC1', en: 'small_brokens_c1' },
    red_line_rate: { th: 'สีต่ำกว่ามาตรฐาน', en: 'red_line_rate' },
    parboiled_red_line: { th: 'เมล็ดแดง', en: 'parboiled_red_line' },
    parboiled_white_rice: { th: 'ข้าวดิบ', en: 'parboiled_white_rice' },
    honey_rice: { th: 'เมล็ดม่วง', en: 'honey_rice' },
    yellow_rice_rate: { th: 'เมล็ดเหลือง', en: 'yellow_rice_rate' },
    black_kernel: { th: 'เมล็ดดำ', en: 'black_kernel' },
    partly_black_peck: { th: 'ดำบางส่วน & จุดดำ', en: 'partly_black_peck' },
    partly_black: { th: 'ดำบางส่วน', en: 'partly_black' },
    imperfection_rate: { th: 'เมล็ดเสีย', en: 'imperfection_rate' },
    sticky_rice_rate: { th: 'ข้าวเหนียว', en: 'sticky_rice_rate' },
    impurity_num: { th: 'เมล็ดอื่นๆ', en: 'impurity_num' },
    paddy_rate: { th: 'ข้าวเปลือก(เมล็ด/กก.)', en: 'paddy_rate' },
    whiteness: { th: 'ความขาว', en: 'whiteness' },
    process_precision: { th: 'ระดับขัดสี', en: 'process_precision' },
    mix_rate: { th: 'อัตราส่วนผสม', en: 'mix_rate' },
    sprout_rate: { th: 'อัตราการงอก', en: 'sprout_rate' },
    unripe_rate: { th: 'อัตราการไม่สุก', en: 'unripe_rate' },
    brown_rice_rate: { th: 'อัตราข้าวกล้อง', en: 'brown_rice_rate' },
    main_rate: { th: 'อัตราหลัก', en: 'main_rate' },
    mix_index: { th: 'ดัชนีผสม', en: 'mix_index' },
    main_index: { th: 'ดัชนีหลัก', en: 'main_index' },
